 ...
 * @author Peter Abeles
 */
public class ExampleObjectTracking<T extends ImageBase> extends JPanel
	 ...
	 */
	public ExampleObjectTracking(TrackerObjectQuad<T> tracker, int desiredWidth, int desiredHeight)
	{
...
//				FactoryTrackerObjectQuad.meanShiftLikelihood(30,5,255, MeanShiftLikelihoodType.HISTOGRAM,colorType);
		...
		ExampleObjectTracking app = new ExampleObjectTracking(tracker,640,480);
